    ...
    try {
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) {
        try {
          ...
          final localPosition = renderBox.globalToLocal(clickPosition);
          final percentX = size.width > 0 ? (localPosition.dx / size.width * 100).round().clamp(0, 100) : 0;
          final percentY = size.height > 0 ? (localPosition.dy / size.height * 100).round().clamp(0, 100) : 0;
