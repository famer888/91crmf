...
class ReportAdGridCard extends StatefulWidget {
  const ReportAdGridCard({super.key, required this.ad});

  final ReportVideoModel ad;

  @override
  State<ReportAdGridCard> createState() => _ReportAdGridCardState();
}

class _ReportAdGridCardState extends State<ReportAdGridCard> {
