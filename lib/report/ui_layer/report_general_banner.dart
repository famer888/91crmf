      ...
      child: AspectRatio(
        ...
        child: Swiper(
          ...
          itemBuilder: (BuildContext context, int index) {
            precacheImage(NetworkImage(CommonUtils.getThumb(widget.data[(index + 1).clamp(0, length - 1)].toJson())), context);
...
class ReportGeneralAppsListVidget extends StatefulWidget {
  ...
  @override
  State<ReportGeneralAppsListVidget> createState() => _ReportGeneralAppsListVidgetState();
}

class _ReportGeneralAppsListVidgetState extends State<ReportGeneralAppsListVidget> {
