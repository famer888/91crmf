...
class ReportAppDownCenterDialog extends StatefulWidget {
  ...
  @override
  State<ReportAppDownCenterDialog> createState() => _ReportAppDownCenterDialogState();
}
...
class ReportAppDownCenterCard extends StatefulWidget {
  ...
  @override
  State<ReportAppDownCenterCard> createState() => _ReportAppDownCenterCardState();
}
    ...
    return Center(
      child: ScrollbarTheme(
        data: ScrollbarThemeData(
          thumbColor: WidgetStateProperty.all(MyTheme.white008Color),
          // 滑动条颜色
          trackColor: WidgetStateProperty.all(MyTheme.white008Color),
          // 滑动条背景颜色
              ...
              GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return VisibilityDetector(
                      key: Key("ReportAppDownCenterDialog_item_${model.reportId}_0_$index"),
              ...
              groupedApps.length < 2
                  ...
                  : GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return VisibilityDetector(
                          key: Key("ReportAppDownCenterDialog_item_${model.reportId}_1_$index"),
                          onVisibilityChanged: (info) {
                            // 当 Widget 可见度超过 50% 时，执行操作
                            if (info.visibleFraction > 0.5) {
                              _showAppAd(model);
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(
                                  model.title ?? '',
                                  style: TextStyle(
                                      color: Colors.white, overflow: TextOverflow.ellipsis, decoration: TextDecoration.none, fontSize: 11.sp),
                                  maxLines: 1,
                                ),
                              ],
                            ),
