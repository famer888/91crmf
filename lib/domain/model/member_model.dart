...
class Member {
  ...
  final int? editAvatar;
  final int? editUser;
  final int? coinsAppPrivilege;
  ...
  Map<String, dynamic> toJson() => {
        ...
        'edit_User': editUser,
        'coins_app_privilege': coinsAppPrivilege,
  ...
  Member copyWith({
    ...
    String? vipIcon,
      ...
      Member(
        ...
        editAvatar: editAvatar ?? this.editAvatar,
        editUser: editUser ?? this.editUser,
        coinsAppPrivilege: coinsAppPrivilege ?? this.coinsAppPrivilege,
