  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        Provider<AIKissDomain>(lazy: false, create: (_) => appRepo),
        Provider<AINovelDomain>(lazy: false, create: (_) => appRepo),
