...
class _BottomNaviBarState extends State<BottomNaviBar> {
  ...
  void initState() {
    ...
    if (!openLive) {
      //关闭直播模块时删除直播路由,默认显示直播模块
      widget.navigationShell.route.branches.removeAt(2);
    }
            ...
            Scaffold(
              ...
              bottomNavigationBar: DecoratedBox(
                ...
                child: BottomNavigationBar(
                  backgroundColor: MyTheme.black_8,
                  elevation: 0,
                  type: BottomNavigationBarType.fixed,
                  selectedFontSize: 11.5.sp,
                  unselectedFontSize: 11.5.sp,
                  unselectedItemColor: MyTheme.color83_75_87,
                  ...
                  items: <BottomNavigationBarItem>[
                    ...
                    BottomNavigationBarItem(
                      ...
                      label: 'home_zy'.tr(context: context),
                    ),
                    BottomNavigationBarItem(
                    ...
                    BottomNavigationBarItem(
                      ...
                      label: 'home_wd'.tr(context: context),
                    ),
                  ],
