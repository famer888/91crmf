...
import 'package:jycrpj/ui_layer/screens/crack/apps/tiktok/widget/tiktok_creator_sub_view.dart';
...
class TiktokCreatorScreen extends StatefulWidget {
  const TiktokCreatorScreen({super.key});
    ...
    return NotificationListener<ScrollNotification>(
        ...
        child: NestedScrollView(
            ...
            headerSliverBuilder: (_, __) => [
                  ...
                  SliverToBoxAdapter(
                    child: TiktokAdsHeader(bannersNotifier: bannersNotifier, color: Colors.white.withOpacity(.7)),
                  ),
                  SliverToBoxAdapter(
                    child: SizedBox(
                      height: 35.w,
                ...
                child: typeIndex == 0
                    ...
                    : TabBarWithView.line(
                        ...
                        views: ((data['time_conf'] ?? []) as List).asMap().entries.map((e) {
                          return _buildView(type, {'type': e.value["param"]}, typeIndex);
                          // return Padding(padding: EdgeInsets.symmetric(horizontal: 12.5.w), child: _buildView());
                        }).toList(),
                      ),
              );
