...
class TiktokCreatorSubView extends StatefulWidget {
  const TiktokCreatorSubView({
    super.key,
    required this.type,
  ...
  @override
  State<TiktokCreatorSubView> createState() => _TiktokCreatorSubViewState();
}

class _TiktokCreatorSubViewState extends State<TiktokCreatorSubView> with TickerProviderStateMixin {
  ...
  Widget _buildUser(dynamic user, {bool vertical = true}) {
    ...
    return GestureDetector(
      onTap: () {
        TiktokUserWorksRoute(id: "${user["aff"]}" ?? "", userName: user["nickname"] ?? "").push(context);
      },
      child: content,
    );
  }
