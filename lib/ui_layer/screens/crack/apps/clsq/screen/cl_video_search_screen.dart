...
class ClVideoSearchScreen extends StatefulWidget {
  ...
  const ClVideoSearchScreen({super.key, required this.args});

  @override
  State<ClVideoSearchScreen> createState() => _ClVideoSearchScreenState();
}

class _ClVideoSearchScreenState extends State<ClVideoSearchScreen> {
          ...
          children: [
              ...
              child: Row(
                children: [
                  ...
                  ReportGestureDetector(
                    onTap: () {
                      _homeConfigNotifier.clearSearchHistory(key: clSearchHistoryKey);
                    },
                    child: Row(
            ...
            Align(
              ...
              child: Selector<HomeConfigNotifier, List<String>>(
                selector: (_, config) => config.getSearchHistory(key: clSearchHistoryKey),
