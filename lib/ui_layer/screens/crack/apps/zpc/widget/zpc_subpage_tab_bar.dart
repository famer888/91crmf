...
class ZpcSubPageTabBar extends StatefulWidget {
  ...
  @override
  State<ZpcSubPageTabBar> createState() => _ZpcSubPageTabBarState();
}

class _ZpcSubPageTabBarState extends State<ZpcSubPageTabBar> {

  late final _homeConfig = context.read<HomeConfigNotifier>();

  List<AppNavModel> _getAppNavList() {
    return _homeConfig.config.zpcSortNav ?? [];
  }
