...
class HjsqAdCard extends StatelessWidget {
  const HjsqAdCard({super.key, required this.ad});
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text(description, style: MyTheme.graya3a2a2_11, maxLines: 1),
                    ],
                  ),
                  Text('   ', style: MyTheme.graya3a2a2_11),
                ],
              ),
            ),
          ],
