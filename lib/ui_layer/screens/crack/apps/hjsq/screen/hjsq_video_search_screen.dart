...
class HjsqVideoSearchScreen extends StatefulWidget {
  final String args;

  const HjsqVideoSearchScreen({super.key, required this.args});

  @override
  State<HjsqVideoSearchScreen> createState() => _HjsqVideoSearchScreenState();
}

class _HjsqVideoSearchScreenState extends State<HjsqVideoSearchScreen> {
  ...
  void onSubmitted(String keyword) {
    ...
    _homeConfigNotifier.upsertSearchHistory(key: hjsqSearchHistoryKey, searchWord: keyword);
              ...
              child: Row(
                children: [
                  ...
                  ReportGestureDetector(
                    onTap: () {
                      _homeConfigNotifier.clearSearchHistory(key: hjsqSearchHistoryKey);
                    },
                    child: Row(
                        ...
                        children: [
                          for (final text in searchHistory)
                            _KeywordTile(
                              ...
                              onDelete: () {
                                _homeConfigNotifier.removeSearchHistory(key: hjsqSearchHistoryKey, searchWord: text);
                              },
                            )
                        ],
                      )
