...
class PZhanSubPageTabBar extends StatefulWidget {
  ...
  @override
  State<PZhanSubPageTabBar> createState() => _PZhanSubPageTabBarState();
}

class _PZhanSubPageTabBarState extends State<PZhanSubPageTabBar> {

  late final _homeConfig = context.read<HomeConfigNotifier>();

  List<AppNavModel> _getAppNavList() {
    return widget.isDiscovery ? (_homeConfig.config.pzhanFindSortNav ?? []) : (_homeConfig.config.pzhanSortNav ?? []);
  }
