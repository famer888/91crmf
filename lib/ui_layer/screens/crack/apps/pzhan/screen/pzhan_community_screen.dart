...
import 'package:jycrpj/ui_layer/screens/crack/apps/pzhan/widget/pzhan_top_navi_view.dart';
...
class PZhanCommunityScreen extends StatefulWidget {
  final int id;
  final CrackApp? crackApp;
  final VoidCallback? openEndDrawer;

  const PZhanCommunityScreen({
    super.key,
    required this.id,
    this.crackApp,
    this.openEndDrawer,
  ...
  @override
  State<PZhanCommunityScreen> createState() => _PZhanCommunityScreenState();
}

class _PZhanCommunityScreenState extends State<PZhanCommunityScreen> {
          ...
          child: Selector<UnlockStatusNotifier, bool>(
              ...
              builder: (context, isUnlockPzhan, child) {
                return Scaffold(
                  ...
                  body: PZhanTopNaviView(id: widget.id, crackApp: widget.crackApp),
                );
              }),
        ),
        // const _BlurView(),
