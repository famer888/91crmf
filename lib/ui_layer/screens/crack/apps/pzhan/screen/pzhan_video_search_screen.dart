...
class PZhanVideoSearchScreen extends StatefulWidget {
  final String args;

  const PZhanVideoSearchScreen({super.key, required this.args});

  @override
  State<PZhanVideoSearchScreen> createState() => _PZhanVideoSearchScreenState();
}

class _PZhanVideoSearchScreenState extends State<PZhanVideoSearchScreen> {
