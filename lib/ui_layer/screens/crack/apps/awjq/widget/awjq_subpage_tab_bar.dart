...
class AwjqSubPageTabBar extends StatefulWidget {
  ...
  @override
  State<AwjqSubPageTabBar> createState() => _AwjqSubPageTabBarState();
}

class _AwjqSubPageTabBarState extends State<AwjqSubPageTabBar> {

  late final _homeConfig = context.read<HomeConfigNotifier>();

  List<AppNavModel> _getAppNavList() {
    return _homeConfig.config.awjqSortNav ?? [];
  }
