...
class Tiktok51TopicScreen extends StatefulWidget {
  const Tiktok51TopicScreen({
    super.key,
    required this.name,
    required this.id,
    required this.api,
  ...
  @override
  State<Tiktok51TopicScreen> createState() => _TiktokTopicScreenState();
}

class _TiktokTopicScreenState extends State<Tiktok51TopicScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _getTabDetail() async {
    ...
    final result = await dynamicDomain.getConstructByApiLink(apiLink: 'tabnew51tikok/tab_detail', params: {'tab_id': widget.id});
    if (result.isValid) {
                              ...
                              Expanded(
                                child: TabBar(
                                  ...
                                  indicator: UnderlineTabIndicator(
                                    ...
                                    borderSide: BorderSide(width: 4.w, color: MyTheme.tiktok51AppPrimaryColor),
                                  ),
                                  indicatorSize: TabBarIndicatorSize.label,
                                  labelStyle: MyTheme.white255_13_M.s16.copyWith(color: MyTheme.tiktok51AppPrimaryColor),
                                  ...
                                  : NotificationListener<ScrollNotification>(
                                      ...
                                      child: MyListView.grid(
                                        ...
                                        onFetchingMore: (currentPage, pageSize) =>
                                            _getMvList(page: currentPage, pageSize: pageSize, sort: e.type),
                                      ),
                                    );
                            }),
                      );
              ...
              Row(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Image.asset(
                        MyImagePaths.appWork,
                        width: 22.w,
                        height: 22.w,
                        color: Colors.white,
                      ),
                      SizedBox(width: 4.w),
                      Text(CommonUtils.renderEnFixedNumber(widget.tabInfo.workNum), style: MyTheme.white13medium.s14),
                    ],
                  ),
                  SizedBox(width: 28.w),
                  Row(
                    ...
                    children: [
                      Image.asset(
                        MyImagePaths.appFavorite,
                        width: 22.w,
                        height: 22.w,
                        color: Colors.white,
                      ),
                      SizedBox(width: 4.w),
                      Text(CommonUtils.renderEnFixedNumber(widget.tabInfo.favoritesNum), style: MyTheme.white13medium.s14),
                    ],
                  ),
                  const Spacer(),
                  // SizedBox(width: 10.w),
