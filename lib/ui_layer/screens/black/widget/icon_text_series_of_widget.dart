...
class CommentIconTextWidget extends StatelessWidget {
  ...
  Widget _buildVerTiktokWidget() {
    ...
    return Convenience.buildChildActionWidget(onTap: () => callback?.call(), margin: EdgeInsets.only(top: 15.w), width: 43.w, child: current);
  }
}
...
class _LikeIconTextWidgetState extends State<LikeIconTextWidget> {
  ...
  Widget _buildVerTiktokWidget() {
    ...
    return Convenience.buildChildActionWidget(onTap: () => onTap(), margin: EdgeInsets.only(top: 15.w), width: 43.w, child: current);
  }
}
...
class _CletIconTextWidgetState extends State<CletIconTextWidget> {
  ...
  Widget _buildHorLayoutWidget() {
    ...
    return Convenience.buildChildActionWidget(onTap: () => onTap(), height: 30.w, child: current);
  }
