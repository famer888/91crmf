...
import 'package:jycrpj/ui_layer/screens/black/widget/black_title.dart';
import 'package:jycrpj/ui_layer/screens/black/widget/html_body_widget.dart';
import 'package:jycrpj/ui_layer/screens/black/widget/icon_text_series_of_widget.dart';
import 'package:jycrpj/ui_layer/screens/black/widget/index_key.dart';
...
class _BlackDetailContentViewState extends State<BlackDetailContentView> {
      ...
      SizedBox(
        ...
        child: GridView.builder(
          ...
          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
              childAspectRatio: 90 / (recommends.length <= 2 ? 170 : 150), crossAxisCount: 1, mainAxisSpacing: 6.w),
  ...
  Widget buildChildActionWidget({
    ...
    if (onTap != null) {
      child = IntervalGestureWidget(onTap: onTap, child: child);
    }
