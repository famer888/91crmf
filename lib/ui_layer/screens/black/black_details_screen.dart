...
import 'black_detail_content_view.dart';
import 'comment.dart';
import 'widget/icon_text_series_of_widget.dart';
import 'widget/index_key.dart';
  ...
  Widget _buildEmptyCommentWidget(CurDetailsModel? cur) {
    return Column(mainAxisSize: MainAxisSize.min, children: [
      ...
      if ((cur?.commentNum ?? 0) <= 0)
        Convenience.buildChildActionWidget(
          padding: EdgeInsets.fromLTRB(15.w, 20.w, 15.w, 10.w),
          text: 'gjplb'.tr(context: context),
