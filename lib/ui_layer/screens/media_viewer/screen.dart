...
class _MediaViewerScreenState extends State<MediaViewerScreen> {
  ...
  MediaModel get _currentMediaModel =>
      widget.pramas['resources'][_selectedIndex] as MediaModel;
          ...
          Stack(
            children: [
              ReportGestureDetector(
                ...
                onTap: () {
                  if (_currentMediaModel.type == MyMediaType.video) return;
    ...
    return data.mediaUrl.isEmpty && (data.unlockCoins ?? 0) > 0
        ...
        : Builder(builder: (_) {
            ...
            return ShortvMvPlayer(
              ...
              noBack: true,
              needSlide: true, //false 防止滑动冲突，导致无法滑动到照片页 这里没有多的照片 直接用true
            );
          });
  }
}
