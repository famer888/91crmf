...
class _ApiLinkViewState extends State<ApiLinkView> {
  ...
  Future<List<FeedModel>?> _getData({
    ...
    if (result.status == 1) {
      ...
      if (result.data['part'] case final List data when data.isNotEmpty && partNotifier.value.isEmpty) {
                    ...
                    onTap: () {
                      ...
                      if (redirectType < 3) {
                        ...
                        if (partsItem.type == '0') {
                          ...
                          MoreVideoRoute(name: partsItem.title, id: linkUrl, api: '').push(context);
                        }
                      }
                    },
                    child: SizedBox(
                                    ...
                                    onTap: () {
                                      ...
                                      if (redirectType < 3) {
                                        ...
                                        if (topic.openType == 0) {
                                          ...
                                          MoreVideoRoute(name: topic.name, id: topic.linkUrl, api: '').push(context);
                                        }
                                      }
                                    },
                                    child: Text(
