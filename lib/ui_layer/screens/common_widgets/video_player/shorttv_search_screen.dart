...
class ShorttvSearchScreen extends StatefulWidget {
  const ShorttvSearchScreen({super.key, required this.args});

  final String args;

  @override
  State<ShorttvSearchScreen> createState() => _ShorttvSearchScreenState();
}

class _ShorttvSearchScreenState extends State<ShorttvSearchScreen> {
                ...
                children: [
                    ...
                    child: Row(
                      children: [
                        ...
                        ReportGestureDetector(
                          onTap: () {
                            _homeConfigNotifier.clearSearchHistory(key: dspSearchHistoryKey);
                          },
                          child: Row(
                  ...
                  Align(
                    ...
                    child: Selector<HomeConfigNotifier, List<String>>(
                      selector: (_, config) => config.getSearchHistory(key: dspSearchHistoryKey),
...
class _SearchContentViewState extends State<_SearchContentView> {
  ...
  final ValueNotifier<List<HotWordModel>> _hotsNotifier = ValueNotifier([]);
  ...
  Future _initData() async {
    ...
    if (result.isValid && mounted) {
      ...
      if (data['top'] != null) {
        final map = data['top'];
        final shorttvSearchHotModel = ShorttvSearchHotModel.fromJson(map);
        _hotsNotifier.value = shorttvSearchHotModel.vlogList;
      }
    ...
    return Column(
      children: [
        ...
        ValueListenableBuilder(
          valueListenable: _bannersNotifier,
          builder: (context, banners, child) {
            ...
            // );
            return ReportGeneralAppsListVidget(data: banners);
          },
        ),
        ValueListenableBuilder(
                ...
                children: [
                  ...
                  ListView.builder(
                      ...
                      itemBuilder: (context, index) => ReportGestureDetector(
                            behavior: HitTestBehavior.translucent,
                            onTap: () {
                              widget.onSubmitted(hots[index].work);
                            },
                            child: SizedBox(
                              height: 35.w,
                              child: Row(
