...
class MyDialog {
  static Future<T?> showBottomDialog<T extends Object?>({
    ...
    return showGeneralDialog<T>(
      ...
      transitionBuilder: (context, animation, secondaryAnimation, childWidget) {
        if (!needTransition) {
          return Align(alignment: Alignment.bottomCenter, child: childWidget);
        }
                        ...
                        : Expanded(
                            child: ReportGestureDetector(
                              ...
                              child: Container(
                                ...
                                padding: EdgeInsets.symmetric(horizontal: 20.w),
                                decoration:
                                    BoxDecoration(gradient: MyTheme.shareButtonGradient, borderRadius: BorderRadius.all(Radius.circular(10.w))),
