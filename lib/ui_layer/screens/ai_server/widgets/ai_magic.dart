...
import 'package:jycrpj/ui_layer/screens/ai_server/widgets/card/magic_card.dart';
...
class _AIMagicState extends State<AIMagic> {
  ...
  late final config = context.watch<HomeConfigNotifier>().config;
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: MyListView.grid(
        ...
        itemBuilder: (context, item, index) => MagicCard(data: item, coins: config.payAiMagic),
