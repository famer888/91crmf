  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:
          TabBarWithView.line(
            isCenter: true,
            titles: _tabs.map((tab) => tab['title'] as String).toList(), views: [KeepAliveWrapper(
...
class _SelectOptionsListState extends State<SelectOptionsList> {
        ...
        Row(
          children: [
            ...
            RichText(
              ...
              TextSpan(text: '$payAiDraws', style: MyTheme.orange247_15),
  ...
  RegularDialog _buildUseCoinsConfirmDialog() {
    return RegularDialog(
      buttonText: 'qd'.tr(),
      cancelText: 'qx'.tr(),
      title: 'ts'.tr(),
  ...
  Future<void> _checkPerm() async {
    if (freeNumber > 0) {
      ...
      CommonUtils.showDialog(
        context: context,
        builder: (context) => _buildUseCoinsConfirmDialog(),
      );
    }
  }
        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: const Color(0xff1b1c2b),
              border: Border.all(
                color: isSelected ? MyTheme.gradient_90_114_colors.first : const Color(0xff1b1c2b),
                width: 1.w,
              ),
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color:
                            isSelected ? MyTheme.gradient_90_114_colors.first : const Color(0xff1b1c2b),
                        width: 1.w,
                      ),
                  ...
                  Text(
                    option.name,
                    style: TextStyle(
                      color: isSelected ? MyTheme.gradient_90_114_colors.first : Colors.white,
                      fontSize: 12.sp,
                    ),
                  )
                ],
