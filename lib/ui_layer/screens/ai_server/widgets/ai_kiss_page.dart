...
class _AIKissPageState extends State<AIKissPage> {
        ...
        Row(
          children: [
            ...
            RichText(
              ...
              TextSpan(
                  text: '$kissCoinsValue', style: MyTheme.orange247_15),
  ...
  void _onSubmitKiss({required int kissCoinsValue}) async {
  ...
  Widget build(BuildContext context) {
    ...
    final int kissCoinsValue = homeConfig.config.payAiKiss;
    final int freeNumber = user.member.aiKissValue;
                ...
                child: Container(
                  ...
                  child: Center(
                    ...
                    freeNumber > 0
                        ...
                        : '需消耗 $kissCoinsValue 金币【余额 $coins】生成',
