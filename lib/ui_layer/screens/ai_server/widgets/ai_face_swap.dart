...
class _AIFaceSwapState extends State<AIFaceSwap> {
  ...
  late final userNotifier = context.watch<UserNotifier>();
  late final userCoins = userNotifier.member.money;
  late List<FaceNavigatorModel> faceNav = [];
  late List<FaceSortModel> titles = [];
  late int faceCoinsValue = _homeConfig.config.faceCoins;
  late int freeNumber = userNotifier.member.imgFaceValue;
        ...
        Row(
          children: [
            ...
            RichText(
              ...
              TextSpan(
                  text: '$faceCoinsValue', style: MyTheme.orange247_15),
                ...
                children: [
                  ...
                  Stack(
                    children: [
                      ...
                      CustomPaint(
                        size: Size(double.infinity, 140.w),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: freeNumber > 0 ? Center(
                        child: Text('免费生成（剩余 $freeNumber 次）',
                            style: MyTheme.white15bold),
                      ) : Center(
                        child: Text('需消耗 $faceCoinsValue 金币【余额 $userCoins】生成',
                            style: MyTheme.white15bold),
                      ),
                    ),
                  ),
