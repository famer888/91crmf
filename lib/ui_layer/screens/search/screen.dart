                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        gradient: LinearGradient(
                                          colors: [
                                            Color(index == 0 ? 0xFFff9020 : (index == 1 ? 0xFF1afbb5 : (index == 2 ? 0xFFa3fb59 : 0xFF7e7d8b))),
                                            Color(index == 0 ? 0xFFf55b5b : (index == 1 ? 0xFF13c4d6 : (index == 2 ? 0xFF21da3f : 0xFF9c9ea7)))
                                          ],
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        ...
                                        style: TextStyle(
                                          fontSize: 13.sp,
                                          color: const Color.fromRGBO(231, 98, 54, 1.0),
                                        ),
                                      ),
                                    ],
                                  ),
