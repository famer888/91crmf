...
import 'package:jycrpj/ui_layer/screens/apps/91aw/widget/aw91_api_link_view.dart';
...
class Aw91TopNaviView extends StatefulWidget {
  const Aw91TopNaviView({super.key, this.id});
...
class _Aw91TopNaviViewState extends State<Aw91TopNaviView> with TickerProviderStateMixin {
  ...
  Future<void> _init() async {
    ...
    final result = await _appDomain.getConstructByApiLink(apiLink: 'element91aw/getElementById', params: {'id': widget.id});
