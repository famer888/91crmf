...
class Aw91ApiLinkView extends StatefulWidget {
  const Aw91ApiLinkView({super.key, this.showRightList = false, required this.linkModel, required this.onLinkNavTap});
  ...
  @override
  State<Aw91ApiLinkView> createState() => _Aw91ApiLinkViewState();
}

class _Aw91ApiLinkViewState extends State<Aw91ApiLinkView> {
  ...
  late final List<AppNavModel> titles = _homeConfig.config.aw91SortNav ?? [];
  ...
  Widget build(BuildContext context) {
    ...
    return NestedScrollView(
      ...
      body: TabBarWithView.fillColor(
        ...
        labelStyle: TextStyle(color: MyTheme.aw91AppPrimaryColor, fontSize: 16.sp, fontWeight: FontWeight.w500),
                    ...
                    onTap: () {
                      ...
                      if (redirectType < 3) {
                        ...
                        if (partsItem.type == '0') {
                          ...
                          MoreVideoRoute(name: partsItem.title, id: linkUrl, api: 'mv91aw/list_construct').push(context);
                        }
                      }
                    },
                    child: SizedBox(
                                    ...
                                    onTap: () {
                                      ...
                                      if (redirectType < 3) {
                                        ...
                                        if (topic.openType == 0) {
                                          ...
                                          MoreVideoRoute(name: topic.name, id: topic.linkUrl, api: 'mv91aw/list_construct').push(context);
                                        }
                                      }
                                    },
