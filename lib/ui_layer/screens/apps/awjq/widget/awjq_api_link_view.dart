...
class AwjqApiLinkView extends StatefulWidget {
  const AwjqApiLinkView({super.key, this.showRightList = false, required this.linkModel, required this.onLinkNavTap});
  ...
  @override
  State<AwjqApiLinkView> createState() => _AwjqApiLinkViewState();
}

class _AwjqApiLinkViewState extends State<AwjqApiLinkView> {
  ...
  late final List<AppNavModel> titles = _homeConfig.config.awjqSortNav ?? [];
                    ...
                    onTap: () {
                      ...
                      if (redirectType < 3) {
                        ...
                        if (partsItem.type == '0') {
                          ...
                          MoreVideoRoute(name: partsItem.title, id: linkUrl, api: 'mvawjq/list_construct').push(context);
                        }
                      }
                    },
                    child: SizedBox(
                                    ...
                                    onTap: () {
                                      ...
                                      if (redirectType < 3) {
                                        ...
                                        if (topic.openType == 0) {
                                          ...
                                          MoreVideoRoute(name: topic.name, id: topic.linkUrl, api: 'mvawjq/list_construct').push(context);
                                        }
                                      }
                                    },
