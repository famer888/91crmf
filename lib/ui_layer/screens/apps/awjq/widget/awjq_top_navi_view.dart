...
import 'package:jycrpj/ui_layer/screens/apps/awjq/widget/awjq_api_link_view.dart';
...
class AwjqTopNaviView extends StatefulWidget {
  const AwjqTopNaviView({super.key, this.id});
...
class _AwjqTopNaviViewState extends State<AwjqTopNaviView> with TickerProviderStateMixin {
  ...
  Future<void> _init() async {
    ...
    final result = await _appDomain.getConstructByApiLink(apiLink: 'elementawjq/getElementById', params: {'id': widget.id});
