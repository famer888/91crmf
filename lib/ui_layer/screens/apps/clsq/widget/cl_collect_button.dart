...
class ClCollectButton extends StatefulWidget {
  final int id;
  final String apiUrl;
  final bool isCollected;
  final CollectCallback callback;

  const ClCollectButton({super.key, required this.apiUrl, required this.isCollected, required this.id, required this.callback});

  @override
  State<ClCollectButton> createState() => _ClCollectButtonState();
}

class _ClCollectButtonState extends State<ClCollectButton> {
      ...
      child: Row(
        ...
        children: [
          SizedBox(
            ...
            height: 20.w,
            child: _isCollected
                ? MyImage.asset(MyImagePaths.appCollectRedOn, width: 20.w, height: 20.w, color: MyTheme.clAppPrimaryColor)
