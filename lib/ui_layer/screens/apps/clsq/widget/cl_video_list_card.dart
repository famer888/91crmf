...
class ClVideoListCard extends StatelessWidget {
  const ClVideoListCard({super.key, required this.data, this.isInVideoDetail = false});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      onTap: () {
        final updateDeedModel = data.copyWith(crackAppType: CrackAppType.clsq.type);
