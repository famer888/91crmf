...
import 'package:jycrpj/ui_layer/screens/apps/zpc/widget/zpc_api_link_view.dart';
...
class ZpcTopNaviView extends StatefulWidget {
  const ZpcTopNaviView({super.key, this.id});
...
class _ZpcTopNaviViewState extends State<ZpcTopNaviView> with TickerProviderStateMixin {
  ...
  Future<void> _init() async {
    ...
    final result = await _appDomain.getConstructByApiLink(apiLink: 'elementzpc/getElementById', params: {'id': widget.id});
