...
class ZpcApiLinkView extends StatefulWidget {
  const ZpcApiLinkView({super.key, this.showRightList = false, required this.linkModel, required this.onLinkNavTap});
  ...
  @override
  State<ZpcApiLinkView> createState() => _ZpcApiLinkViewState();
}

class _ZpcApiLinkViewState extends State<ZpcApiLinkView> {
  ...
  late final List<AppNavModel> titles = _homeConfig.config.zpcSortNav ?? [];
  ...
  Future<List<FeedModel>?> _getData({
    ...
    CommonUtils.log('getData: ${widget.linkModel.api}');
    ...
    if (result.status == 1) {
      ...
      return result.data['list']?.map<FeedModel>((x) => FeedModel.fromJson(x)).toList();
    } else {
  ...
  Widget build(BuildContext context) {
    ...
    return NestedScrollView(
      ...
      body: TabBarWithView.fillColor(
        ...
        labelStyle: TextStyle(color: MyTheme.zpcAppPrimaryColor, fontSize: 16.sp, fontWeight: FontWeight.w500),
        unselectedLabelStyle: TextStyle(color: const Color.fromRGBO(17, 16, 18, 1), fontSize: 16.sp, fontWeight: FontWeight.w400),
          ...
          for (final AppNavModel nav in titles)
            ValueListenableBuilder(
                ...
                builder: (context, isList, child) {
                  return isList
                      ? MyListView.list(
                          itemBuilder: (context, item, index) => ZpcFeedCard(isList: true, feed: item),
        ...
        ValueListenableBuilder(
          ...
          builder: (context, banners, child) {
            ...
            return Padding(
              ...
              child: GeneralBannerAppsListWidget(data: banners, titleColor: const Color.fromRGBO(17, 16, 18, 1)),
            );
                    ...
                    onTap: () {
                      ...
                      if (redirectType < 3) {
                        ...
                        if (partsItem.type == '0') {
                          ...
                          MoreVideoRoute(name: partsItem.title, id: linkUrl, api: 'mvzpc/list_construct').push(context);
                        }
                      }
                    },
                    child: SizedBox(
                                    ...
                                    onTap: () {
                                      ...
                                      if (redirectType < 3) {
                                        ...
                                        if (topic.openType == 0) {
                                          ...
                                          MoreVideoRoute(name: topic.name, id: topic.linkUrl, api: 'mvzpc/list_construct').push(context);
                                        }
                                      }
                                    },
                            ...
                            child: Row(
                              ...
                              children: [
                                Text('zkckgd'.tr(context: context),
                                    style: TextStyle(color: const Color.fromRGBO(17, 16, 18, 1), fontSize: 12.sp)),
                                SizedBox(width: 3.w),
