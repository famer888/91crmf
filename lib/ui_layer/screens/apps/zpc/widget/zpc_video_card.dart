...
class ZpcVideoCard extends StatelessWidget {
  const ZpcVideoCard({super.key, required this.data, this.isInVideoDetail = false});
          ...
          children: [
            ...
            Expanded(
              child: Container(
                ...
                child: Text(data.title, style: MyTheme.black12, maxLines: 1, overflow: TextOverflow.ellipsis),
              ),
            ),
          ],
        );
