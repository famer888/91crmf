...
import 'package:jycrpj/ui_layer/screens/apps/zpc/widget/zpc_collect_button.dart';
...
class _BodyState extends State<_Body> with TickerProviderStateMixin {
  ...
  Widget _buildBannerWidget(List<Notice>? list) {
    ...
    try {
      ...
      return Padding(
          padding: EdgeInsets.all(MyTheme.pagePadding),
          child: GeneralBannerAppsListWidget(data: banners, titleColor: const Color.fromRGBO(51, 51, 51, 1)));
    } catch (e) {
