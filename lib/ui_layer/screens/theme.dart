...
class MyTheme {
  ...
  static const gradient_90_114_colors = [
    Color.fromRGBO(255, 23, 50, 1),
    Color.fromRGBO(255, 71, 144, 1),
  ];
  ...
  static const subOrgGradient = LinearGradient(colors: [
    Color.fromRGBO(252, 208, 104, 1),
    Color.fromRGBO(244, 109, 27, 1),
  ]);

  static const subButGradient = LinearGradient(colors: [
    Color.fromRGBO(224, 146, 255, 1),
    Color.fromRGBO(152, 54, 255, 1),
    Color.fromRGBO(164, 79, 255, 1),
  ]);

  static const subExcGradient = LinearGradient(colors: [
    Color.fromRGBO(255, 146, 201, 1),
    Color.fromRGBO(255, 54, 155, 1),
    Color.fromRGBO(164, 79, 255, 1),
  ]);

  static const subCoinGradient = LinearGradient(colors: [
    Color.fromRGBO(248, 103, 101, 1),
    Color.fromRGBO(231, 13, 26, 1),
  ]);
  ...
  static const LinearGradient gradient_90_135 = LinearGradient(
    colors: gradient_90_135_colors,
    begin: Alignment.centerLeft,
    end: Alignment.centerRight,
  );
  ...
  static const bgColor = Color.fromRGBO(12, 1, 8, 1);
  static const black_8 = Color.fromRGBO(0, 0, 0, 0.85);
  ...
  static const blueColor81_151_241 = blueColor64;

  static const blueColor63 = blueColor64;
  static const color247_93_96 = Color.fromRGBO(247, 93, 96, 1);
  static const blueColor64 = Color.fromRGBO(241, 40, 84, 1);
  static const color83_75_87 = Color.fromRGBO(83, 75, 87, 1);

  static const cyanColor00edfd = Color.fromRGBO(55, 110, 246, 1);

  static const jellyCyanColor103224185 = blueColor64;
