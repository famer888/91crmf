...
import 'package:jycrpj/domain/model/welfare_task_model.dart';
import 'package:jycrpj/domain/remote_domain/domains/sign.dart';
          ...
          MyButton.gradient(
            ...
            onPressed: () async {
              CommonUtils.copyToClipboard(
                  text: '${member.share?.affUrlCopy?.url}');
