...
class _MineSetupScreenState extends State<MineSetupScreen> {
  ...
  Future<void> _bindEmail() async {
    ...
    if (user.bindEmail == 1) {
      MyToast.showText(text: 'nyjbdyx'.tr());
    } else {
      const MineBindEmailRoute().push(context);
    }
  }
  ...
  Future<void> _logOut() async {
    ...
    CommonUtils.logoutStopVoicePlayer();
  ...
  Widget build(BuildContext context) {
    ...
    return ScreenBackground(
        child: Scaffold(
            appBar: MyAppBar(title: 'bjzl'.tr(context: context)),
            body: Column(
              children: [
                                ...
                                Center(
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      borderRadius: BorderRadius.circular(70.w / 2),
                                    ),
                                  ),
                                ),
                                Center(
                                  child: Container(
                                    ...
                                    child: MyImage.asset(MyImagePaths.appEditCamera, width: 20.w, height: 20.w, fit: BoxFit.cover),
                                  ),
                                ),
                              ],
                            ),
                            SizedBox(height: 10.w),
                            Text('xgtx'.tr(context: context), style: MyTheme.gray187_15_M),
                          ],
                        ),
                      );
                    }),
                        ...
                        Selector<UserNotifier, Member>(
                            ...
                            builder: (context, member, child) {
                              return SetupItem(
                                ...
                                onTap: () => _editNickName(vipLevel: member.vipLevel),
                              );
                            }),
                        const SetupItemDivider(),
                        SetupItem(title: 'bdyx'.tr(context: context), onTap: _bindEmail),
                        const SetupItemDivider(),
                        SetupItem(title: 'qchc'.tr(context: context), onTap: _clearCache),
                        const SetupItemDivider(),
                        SetupItem(
                ...
                Selector<UserNotifier, bool>(
                  selector: (_, userNotifier) => userNotifier.tokenStatus == MyTokenStatus.valid,
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  borderRadius: BorderRadius.all(Radius.circular(49.w / 2)),
                                  border: Border(top: BorderSide(color: const Color(0xFF272727), width: 1.w)),
                                ),
                                child: SafeArea(
                                  child: Container(
                                    height: 49.w,
                                    alignment: Alignment.center,
                                    child: Text('tcdl'.tr(context: context), style: MyTheme.white255_18_B),
                                  ),
                                ),
                              ),
                            ),
    ...
    return GestureDetector(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            Text(title, style: MyTheme.black64_15_M),
            Expanded(
              child: Row(
                ...
                children: [
                  ...
                  MyImage.asset(MyImagePaths.appMineRightArrow, width: 25.w, height: 25.w)
                ],
              ),
            )
          ],
