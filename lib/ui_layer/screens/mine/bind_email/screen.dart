                  ...
                  children: [
                      ...
                      children: [
                        Container(
                          ...
                          child: Center(
                            child: TextField(
                              focusNode: focusNode,
                              autofocus: widget.isForPop || kIsWeb ? false : true,
                              ...
                              decoration: InputDecoration(
                                ...
                                hintText: '${'qing'.tr(context: context)}${'sryx'.tr(context: context)}',
                                hintStyle: TextStyle(
                            ...
                            children: [
                              Expanded(
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    hoverColor: Colors.white,
                                    hintText: '${'qing'.tr(context: context)}${'txyzm'.tr(context: context)}',
                                    hintStyle: TextStyle(
                                      color: const Color(0xff999999),
                                      fontWeight: FontWeight.w500,
                                      fontSize: 15.sp,
                              ...
                              ReportGestureDetector(
                                ...
                                child: Container(
                                  width: 95.w,
                                  // height: 24.w,
                                  decoration: const BoxDecoration(color: MyTheme.blueColor64
                                      // borderRadius: BorderRadius.circular(12.w),
                                      ),
                                  child: Center(
                                    child: Text(seconds == 60 ? 'hqyzm'.tr() : "$seconds${'mhcf'.tr()}",
                                        style: seconds == 60 ? MyTheme.white255_14 : MyTheme.white255_14),
                                  ),
                                ),
                              )
                            ],
                    ...
                    ReportGestureDetector(
                      ...
                      child: Container(
                        height: 40.w,
                        clipBehavior: Clip.hardEdge,
                        decoration: BoxDecoration(gradient: MyTheme.gradient_90_114, borderRadius: BorderRadius.all(Radius.circular(4.w))),
                        child: Center(
                          child: Text(
