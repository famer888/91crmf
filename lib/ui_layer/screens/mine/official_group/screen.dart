...
class MineOfficialGroupScreen extends StatefulWidget {
  ...
  @override
  State<MineOfficialGroupScreen> createState() => _MineOfficialGroupScreenState();
}
...
class _MineOfficialGroupScreenState extends State<MineOfficialGroupScreen> {
  ...
  Widget _contactItem({required OfficeContact itemData}) {
    return Column(
      ...
      children: [
        Text('${itemData.name}', style: MyTheme.white255_18_M),
        SizedBox(height: 8.w),
        Text('${itemData.decs}', style: MyTheme.gray95_12),
        SizedBox(height: 10.w),
        Column(
          mainAxisSize: MainAxisSize.min,
          children: (itemData.list ?? []).map<Widget>((value) => AppInfo(info: value)).toList(),
        ),
        // Container(
        //   margin: EdgeInsets.only(top: 11.5.w, bottom: 20.w),
        //   padding: EdgeInsets.all(15.w),
        //   decoration: BoxDecoration(borderRadius: BorderRadius.circular(10.w), color: const Color.fromRGBO(255, 255, 255, 0.1)),
  ...
  Widget build(BuildContext context) {
    return ScreenBackground(
      child: Scaffold(
        appBar: MyAppBar(title: 'jqkc'.tr(context: context)),
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: const LinearGradient(
                begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [Color.fromRGBO(105, 60, 164, 0.8), Color.fromRGBO(74, 9, 9, 0.8)]),
          ),
        ),
        Container(
          height: 60.w,
            ...
            children: [
              Expanded(
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    MyImage.asset(info.type == 'Telegram' ? MyImagePaths.appWdLxtgN : MyImagePaths.appWdLxpotao, width: 38.8.w, height: 38.8.w),
                    SizedBox(width: 13.w),
                    Flexible(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        mainAxisSize: MainAxisSize.min,
                        children: [Text('${info.name}', style: MyTheme.white255_15_M), Text('${info.decs}', style: MyTheme.gray150_12)],
                      ),
                    )
                  ],
                ),
              ...
              ReportGestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(gradient: MyTheme.gradient_90_114, borderRadius: BorderRadius.circular(15.w)),
                  child: Text('ljjr'.tr(context: context), style: MyTheme.white11),
                ),
              )
            ],
          ),
