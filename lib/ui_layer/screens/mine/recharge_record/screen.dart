...
class _RechargeRecordScreenState extends State<RechargeRecordScreen> {
  ...
  Future<List<Order>?> _getData({required int page, required int pageSize}) async {
    ...
    return ScreenBackground(
      ...
      appBar: MyAppBar(
        ...
        rightWidget: GestureDetector(
          ...
          child: Text('lxkf'.tr(context: context), style: MyTheme.gray150_14),
        ),
      ),
        ...
        children: [
          Row(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  CommonUtils.copyToClipboard(text: '${'ddbh'.tr(context: context)}：${order.id}');
