...
class UserService extends BaseService {
  ...
  /// 填写邀请码
  AsyncJson toInvitation({required String affCode}) => post('/invitation', data: {'aff_code': affCode});

  AsyncJson communityFollowUser({required String aff}) => post('/toggle_follow', data: {
        'aff': aff,
      });
  ...
  /// 提现  删除银行卡
  AsyncJson cashDeleteBankCard({required int cardId}) => post('/del_bankcard', data: {'id': cardId});
  ...
  AsyncJson userContactBuy({
    required int aff,
      ...
      post('/buy', data: {'aff': aff});

  /// 购买App
  AsyncJson userAppBuy({required String source, required int type})
    => post('/buy_app', data: {'source': source, 'type': type});
}
