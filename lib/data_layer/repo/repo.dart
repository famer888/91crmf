...
import 'package:jycrpj/data_layer/data_source/remote/aiaudio_service.dart';
import 'package:jycrpj/data_layer/data_source/remote/asmr_service.dart';
import 'package:jycrpj/data_layer/data_source/remote/aikiss_service.dart';
import 'package:jycrpj/data_layer/data_source/remote/black_service.dart';
import 'package:jycrpj/data_layer/data_source/remote/buy_service.dart';
import 'package:jycrpj/data_layer/data_source/remote/cartoon_service.dart';
import 'package:jycrpj/data_layer/data_source/remote/game_service.dart';
...
import 'package:jycrpj/domain/model/ai/ai_magic_record_model.dart';
import 'package:jycrpj/domain/model/ai_model.dart';
import 'package:jycrpj/domain/model/buy_model.dart';
import 'package:jycrpj/domain/model/home_ads_model.dart';
import 'package:jycrpj/domain/model/live_model.dart';
import 'package:jycrpj/domain/model/live_video_detail_model.dart';
...
import 'package:jycrpj/domain/remote_domain/domains/invite_domain.dart';
...
import '../data_source/remote/crack_service.dart';
...
import '../data_source/remote/report_service.dart';
...
abstract class _BaseAppRepo implements AppDomain {
  ...
  void initLine({
    ...
    // 测试服
    unCheckLines = ['https://dx-105-api1.ympxbys.xyz/api.php'];
